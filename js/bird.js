...
const { offsetWidth: birdWidth, offsetHeight: birdHeight } = $viewport;
...
renderer.setSize(birdWidth, birdHeight);
renderer.setClearColor(0xffffff, 1.0);
renderer.setPixelRatio(window.devicePixelRatio || 1);
$viewport.appendChild(renderer.domElement);

const camera = new THREE.PerspectiveCamera(45, birdWidth / birdHeight, 1, 100);
...
window.addEventListener('resize', () => {
  ...
  camera.aspect = birdWidth / birdHeight;
...
$indicator.style.birdWidth = '50px';
$indicator.style.birdHeight = '50px';
